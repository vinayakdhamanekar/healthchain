...
const BADGES: TrustBadge[] = [
  {
    ...
    title: "",
    description:
      "Review the current security evidence and controls relevant to your deployment. ",
    linkLabel: "",
    linkHref:
      "",
    external: true,
  },
  {
    ...
    label: "",
    title: "",
    description: "Agree access, source connections and data responsibilities before implementation. ",
    linkLabel: "",
    linkHref: "",
  },
  {
    code: "Coding governance",
    label: "",
    title: "",
    description: "Your team retains coding approval. Submission roles are defined in scope.",
    linkLabel: "",
    linkHref: "",
    external: true,
  },
    ...
    >
      ...
      <div className="relative">
        ...
        <h2 className="text-[36px] md:text-[48px] font-semibold leading-[1.06] tracking-[-0.025em] text-[#F7F4EE] max-w-[620px] mb-10">
          Evidence for your review. Clarity on responsibilities. 
        </h2>
