...
export default function SolutionsHero(): JSX.Element {
  return (
    ...
    >
      ...
      {/* Headline */}
      <h1 className="text-[38px] md:text-[56px] lg:text-[68px] font-semibold tracking-[-0.03em] leading-[1.05] text-[#fff] mx-auto">
        A real compliance foundation.
      </h1>

      {/* Subtext */}
      <p className="mt-6 text-[17px] md:text-[19px] leading-[1.6] text-[#fff] max-w-[600px] mx-auto">
        The first step to accelerating payer performance and seeing tangible health data outcomes, without a compliance scramble every time a new mandate lands.
      </p>
