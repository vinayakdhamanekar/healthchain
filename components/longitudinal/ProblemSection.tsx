...
const CARDS: ProblemCard[] = [
  {
    ...
    title: "The same member, three times",
    badge: "Impact",
    description:
      "One person shows up as different IDs across claims, clinical, and pharmacy systems. Teams spend more time deduping records than acting on them.",
    label: "Misattributed cost and care",
    labelBg: "bg-[#FCEAE7]",
    labelText: "text-[#A84830]",
  },
  {
    icon: "/icons/Road-Sign-Warning--Streamline-Ultimate.svg",
    title: "Claims without context",
    badge: "Impact",
    description:
      "Claims tell you what was billed, but not what happened. Without labs, vitals, and notes, care gaps increase and risk capture leaks.",
    label: "ROI left on the table",
    labelBg: "bg-[#FDF4E3]",
    labelText: "text-[#9A6820]",
  },
  {
    icon: "/icons/Road-Sign-Warning--Streamline-Ultimate.svg",
    title: "Partial views everywhere",
    description:
      "Each downstream tool pulls its own slice on its own schedule. Teams end up debating which version of the member is correct.",
    label: "Weeks lost to reconciliation",
    badge: "Impact",
    labelBg: "bg-[#F0EDE8]",
  ...
  return (
    <section className="bg-[#F7F3EF] px-7 md:px-14 py-[72px]">
      ...
      <h2 className="text-[32px] md:text-[42px] font-semibold tracking-[-0.03em] leading-[1.08] text-[#1A1A1A] max-w-[640px] mb-4">
        Health data is everywhere. Member truth is nowhere.
      </h2>

      {/* Subtext */}
      <p className="text-[15px] md:text-[17px] leading-[1.65] text-[#57534C] max-w-[600px] mb-12">
        Fragmentation isn't just an engineering headache. It shows up as low quality measures, miscalculated risk, and member experiences that slip through the cracks.
      </p>
