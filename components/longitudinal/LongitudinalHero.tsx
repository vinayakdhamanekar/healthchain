...
export default function LongitudinalHero(): JSX.Element {
  return (
    <section
    ...
    >
      ...
      <h1 className="text-[38px] md:text-[56px] lg:text-[68px] max-w-[880px]  font-semibold tracking-[-0.03em] leading-[1.05] text-[#fff] mx-auto">
        Every source. One longitudinal health record.
      </h1>

      {/* Subtext */}
      <p className="mt-6 text-[17px] md:text-[19px] leading-[1.6] text-[#fff] max-w-[700px] mx-auto">
        Most plans touch a dozen systems for a single member and still can't answer simple questions about their history. Health Chain brings claims, clinical, pharmacy, lab, and SDOH together into one trustworthy record and sends it into the tools your teams already use.
      </p>
